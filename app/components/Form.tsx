      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-10'>
        ...
        <div className="col-span-2">
          <div className='w-[100%]'>
            ...
            {/* @ts-ignore */}
            <textarea onChange={(e) => setDesc(e.target.value)} placeholder='Tell everyone what your pin is about' className=' outline-none  w-full mt-8 pb-4 text-[14px] border-b-[2px] border-gray-400 placeholder-gray-400' />
            {/* @ts-ignore */}
